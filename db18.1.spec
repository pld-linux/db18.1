...
# Source0-md5:	cf3f6700dcb3162ec9371907de133460
...
%if %{with static_libs}
%{__mv} libdb.a libdb-%{libver}.a
%{__mv} libdb_cxx.a libdb_cxx-%{libver}.a
%endif
%if %{with java}
%{__mv} $RPM_BUILD_ROOT%{_libdir}/db.jar $RPM_BUILD_ROOT%{_javadir}/db-%{libver}.jar
%endif
%if %{with default_db}
